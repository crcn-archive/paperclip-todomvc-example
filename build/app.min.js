...
var Todo = BindableObject.extend({
  remove: function () {
    todos.splice(this.todos.indexOf(this), 1);
  }
});


var todos = window.todos = new Todos();
for (var i = 1000; i--;)
todos.create({ text: "clean car" });
todos.create({ text: "wash cat"  });
...
var Controller = BindableObject.extend({
  ...
  addTodos: function (count) {
    var start = Date.now();
    var todos = new Todos();
    for (var i = count||0; i--;) todos.push(new Todo({ text: i }));
...
},{"./todos.pc":2,"bindable-collection":3,"bindable-object":10,"paperclip":71}],2:[function(require,module,exports){
"use strict";module.exports = (function (fragment, block, element, text, comment, parser, modifiers) { return fragment([element("section", {'id':"todoapp"}, [element("header", {'id':"header"}, [element("h1", {}, [text("todos")]), text(" "), element("input", {'type':"text", 'id':"new-todo", 'placeholder':"What needs to be done?", 'model':[{'value':{run: function () { return this.bindTo(['newTodoText'], true); }, refs: [["newTodoText"]]}}], 'onEnter':[{'value':{run: function () { return this.call(this.context, "addNewTodo", []); }, refs: [["addNewTodo"]]}}], 'focus':[{'value':{run: function () { return true; }, refs: []}}]}, [])]), text(" "), element("section", {'id':"main"}, [element("ul", {'id':"todo-list"}, [block({'each':{run: function () { return this.context.get(['todos']); }, refs: [["todos"]]}, 'as':{run: function () { return "model"; }, refs: []}}, (function (fragment, block, element, text, comment, parser, modifiers) { return element("li", {}, [block({'if':{run: function () { return !!this.context.get(['edit']); }, refs: [["edit"]]}}, (function (fragment, block, element, text, comment, parser, modifiers) { return element("input", {'type':"text", 'class':"edit", 'model':[{'value':{run: function () { return this.bindTo(['model', 'text'], true); }, refs: [["model","text"]]}}], 'onEnter':[{'value':{run: function () { return this.set(['edit'], false); }, refs: [["edit"]]}}], 'focus':[{'value':{run: function () { return true; }, refs: []}}]}, []); }), (function (fragment, block, element, text, comment, parser, modifiers) { return block({'else':{run: function () { return true; }, refs: []}}, (function (fragment, block, element, text, comment, parser, modifiers) { return fragment([element("input", {'type':"checkbox", 'class':"toggle"}, []), element("label", {}, [block({'value':{run: function () { return this.context.model.text; }, refs: [["model","text"]]}}, void 0)]), text(" "), element("button", {'class':"destroy"}, [])]); })); }))]); }))]), text(" "), block({'if':{run: function () { return this.context.get(['todos', 'length']); }, refs: [["todos","length"]]}}, (function (fragment, block, element, text, comment, parser, modifiers) { return element("input", {'type':"checkbox", 'id':"toggle-all", 'model':[{'value':{run: function () { return this.bindTo(['todos', 'allCompleted'], true); }, refs: [["todos","allCompleted"]]}}], 'onClick':[{'value':{run: function () { return this.call(this.get(["todos"]), "toggleCompleted", []); }, refs: [["todos","toggleCompleted"]]}}]}, []); }))]), text(" "), block({'if':{run: function () { return this.context.get(['todos', 'length']); }, refs: [["todos","length"]]}}, (function (fragment, block, element, text, comment, parser, modifiers) { return element("footer", {'id':"footer"}, [element("span", {'id':"todo-count"}, [element("strong", {}, [block({'value':{run: function () { return this.context.get(['todos', 'length'])-this.context.get(['todos', 'numCompleted']); }, refs: [["todos","length"],["todos","numCompleted"]]}}, void 0)]), text(" todos left ")]), text(" "), element("ul", {'id':"filters"}, [comment("li>\n          <a data-href=\"allTodos\" data-bind=\"{{ css: { selected: models.states.page == 'all' }}}\">All</a>\n        </li>\n        <li>\n          <a data-href=\"activeTodos\" data-bind=\"{{ css: { selected: models.states.page == 'active' }}}\">Active</a>\n        </li>\n        <li>\n          <a data-href=\"completedTodos\" data-bind=\"{{ css: { selected: models.states.page == 'completed' }}}\">Completed</a>\n        </li")]), text(" "), block({'if':{run: function () { return this.context.get(['todos', 'numCompleted']); }, refs: [["todos","numCompleted"]]}}, (function (fragment, block, element, text, comment, parser, modifiers) { return element("button", {'id':"clear-completed", 'data-bind':[{'onClick':{run: function () { return this.call(this.get(["todos"]), "clearCompleted", []); }, refs: [["todos","clearCompleted"]]}}]}, [text("Clear completed ("), block({'value':{run: function () { return this.context.get(['todos', 'numCompleted']); }, refs: [["todos","numCompleted"]]}}, void 0), text(") ")]); }))]); }))]), text(" "), element("footer", {'id':"info"}, [element("p", {}, [text("Double-click to edit a todo")])])]); })
...
},{"protoclass":134}],53:[function(require,module,exports){
...
},{"../../utils/bind":98,"./event":58}],54:[function(require,module,exports){
var EventDataBinding = require("./event");
...
},{"../../utils/bind":98,"protoclass":134}],59:[function(require,module,exports){
...
},{"../../utils/extend":99,"./change":53,"./delete":54,"./enable":55,"./enter":56,"./escape":57,"./event":58,"./focus":60,"./model":61,"./show":62}],60:[function(require,module,exports){
var BaseBinding = require("./base");
...
},{"../../utils/bind":98,"./base":52,"OpdoqP":51}],62:[function(require,module,exports){
var BaseBinding = require("./base");
...
},{"protoclass":134}],64:[function(require,module,exports){
...
},{"../../utils/extend":99,"./condition":64,"./each":65,"./html":67}],67:[function(require,module,exports){
var BaseBlockBinding = require("./base");
...
},{"protoclass":134}],69:[function(require,module,exports){
var protoclass = require("protoclass");
...
},{"protoclass":134}],70:[function(require,module,exports){
module.exports = {
...
},{"./bindings/attrs/base":52,"./bindings/attrs/factory":59,"./bindings/block/base":63,"./bindings/block/factory":66,"./defaultModifiers":70,"./template":97,"./utils/extend":99,"mojo-application":27}],72:[function(require,module,exports){
...
},{"./base":74,"./parameters":86}],73:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],74:[function(require,module,exports){
var protoclass = require("protoclass");
...
},{"protoclass":134}],75:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./array":72,"./base":74}],80:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],81:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],83:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],84:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],86:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],87:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],88:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],89:[function(require,module,exports){
var BaseExpression = require("./base"),
_ = require("underscore");
...
},{"./base":74,"underscore":136}],90:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],91:[function(require,module,exports){
var BaseExpression = require("./base");
...
},{"./base":74}],92:[function(require,module,exports){
var BaseExpression = require("./base"),
he                 = require("he");
...
},{"./base":74,"he":113}],93:[function(require,module,exports){
...
},{"./parser":94}],94:[function(require,module,exports){
module.exports = (function() {
  /*
...
},{"./ast/array":72,"./ast/assignment":73,"./ast/blockBinding":75,"./ast/call":76,"./ast/commentNode":77,"./ast/doctype":78,"./ast/elementNode":79,"./ast/group":80,"./ast/hash":81,"./ast/literal":82,"./ast/modifier":83,"./ast/not":84,"./ast/operator":85,"./ast/parameters":86,"./ast/reference":87,"./ast/rootNode":88,"./ast/script":89,"./ast/string":90,"./ast/ternaryCondition":91,"./ast/textNode":92}],95:[function(require,module,exports){
...
},{"./ref":96}],96:[function(require,module,exports){
var protoclass = require("protoclass");
...
},{"protoclass":134}],97:[function(require,module,exports){
var protoclass = require("protoclass"),
...
},{"./clips":69,"./parser":93,"./view":102,"./viewRecycler":103,"./writers/block":106,"./writers/comment":107,"./writers/element":109,"./writers/fragment":110,"./writers/text":111,"protoclass":134}],98:[function(require,module,exports){
...
module.exports = View;
},{"./bindings":68,"./utils/syncBindableObjectChanges":101,"bindable-object":10,"document-section":112,"protoclass":134}],103:[function(require,module,exports){
var protoclass            = require("protoclass"),
Bindings                  = require("./bindings"),
createSection             = require("document-section"),
BindableObject            = require("bindable-object"),
...
},{"./bindings":68,"./utils/syncBindableObjectChanges":101,"bindable-object":10,"document-section":112,"protoclass":134}],104:[function(require,module,exports){
var protoclass = require("protoclass");
...
},{"protoclass":134}],105:[function(require,module,exports){
var protoclass = require("protoclass");
...
},{"protoclass":134}],106:[function(require,module,exports){
...
},{"../../script":95,"../../utils":100,"./bindings/unboundValue":104,"./bindings/value":105,"document-section":112}],107:[function(require,module,exports){
module.exports = function (template) {
  var nodeFactory = template.application.nodeFactory;
...
},{"protoclass":134}],109:[function(require,module,exports){
...
},{"../../script":95,"../../utils":100,"./bindings/value":108}],110:[function(require,module,exports){
module.exports = function (template) {
  var nodeFactory = template.application.nodeFactory;
...
},{"nofactor":117,"protoclass":134}],113:[function(require,module,exports){
module.exports=require(49)
},{}],114:[function(require,module,exports){
arguments[4][28][0].apply(exports,arguments)
},{"protoclass":134}],115:[function(require,module,exports){
arguments[4][29][0].apply(exports,arguments)
},{"./base":114,"factories":133}],116:[function(require,module,exports){
arguments[4][30][0].apply(exports,arguments)
},{"./base":114}],117:[function(require,module,exports){
module.exports=require(31)
},{"./custom":115,"./dom":116,"./string":122}],118:[function(require,module,exports){
module.exports=require(32)
},{"./text":125}],119:[function(require,module,exports){
arguments[4][33][0].apply(exports,arguments)
},{"./node":123}],120:[function(require,module,exports){
arguments[4][34][0].apply(exports,arguments)
},{"./container":119,"./style":124}],121:[function(require,module,exports){
module.exports=require(35)
},{"./container":119}],122:[function(require,module,exports){
arguments[4][36][0].apply(exports,arguments)
},{"../base":114,"./comment":118,"./container":119,"./element":120,"./fragment":121,"./text":125,"./voidElements":126}],123:[function(require,module,exports){
arguments[4][37][0].apply(exports,arguments)
},{"protoclass":134}],124:[function(require,module,exports){
arguments[4][38][0].apply(exports,arguments)
},{"protoclass":134}],125:[function(require,module,exports){
arguments[4][39][0].apply(exports,arguments)
},{"./node":123,"he":113}],126:[function(require,module,exports){
module.exports=require(40)
},{"./element":120}],127:[function(require,module,exports){
module.exports=require(41)
},{"./base":128,"./factory":130}],128:[function(require,module,exports){
module.exports=require(42)
},{}],129:[function(require,module,exports){
module.exports=require(43)
},{"./base":128}],130:[function(require,module,exports){
module.exports=require(44)
},{"./base":128,"./class":129,"./fn":131,"type-component":135}],131:[function(require,module,exports){
module.exports=require(45)
},{}],132:[function(require,module,exports){
module.exports=require(46)
},{"./base":128,"./factory":130}],133:[function(require,module,exports){
module.exports=require(47)
},{"./any":127,"./class":129,"./factory":130,"./fn":131,"./group":132}],134:[function(require,module,exports){
module.exports=require(8)
